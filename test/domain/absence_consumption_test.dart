...
void main() {
  test('i permessi dentro una giornata di presenza scalano il plafond', () {
    final c = computeAbsenceConsumption(
      year: 2026,
      entries: [
        _day(
          '2026-07-23',
  ...
  test('sciopero: registrato ma senza plafond', () {
    expect(
      AbsencePlafonds.limitFor(AbsenceKind.strike)?.type,
      AbsenceLimit.none,
    );
    final c = computeAbsenceConsumption(
      year: 2026,
      entries: [_day('2026-06-11', kind: AbsenceKind.strike, absenceMins: 456)],
    );
  ...
  test('i getter esistenti restano la facciata dei contatori', () {
    ...
    final over = computeAbsenceConsumption(
      year: 2026,
      entries: [
        _day(
          '2026-02-03',
          kind: AbsenceKind.shortLeave,
          absenceMins: 38 * 60 + 1,
        ),
      ],
    );
  ...
  test('giornata con causale di giornata E segmento leave della stessa '
